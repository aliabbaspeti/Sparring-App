...
class JiuPlayersList extends StatefulWidget {
  const JiuPlayersList({super.key});

  @override
  State<JiuPlayersList> createState() => _JiuPlayersListState();
}

class _JiuPlayersListState extends State<JiuPlayersList> {
  @override
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: const CTextBold(
                  data: "JIU JITSU Players", color: appcolors.textColorwhite),
            ),
            body: StreamBuilder(
              stream:
                  ...
                  if (snapshot.hasData) {
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          bool isjiuplayer = category.contains("Jiu Jitsu");
                          if (isjiuplayer) {
